...
image::images/access-control-multiple.svg[Access Control multiple]
...
image::images/access-manager.svg[AccessManager]
...
image::images/access-manager-functions.svg[AccessManager functions]
